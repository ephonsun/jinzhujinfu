	...
	<div id="tip-nav" class="row">
		...
		<div class="col-md-8">
			...
			<div class="row">
				...
				<div class="col-md-3"></div>
				<div class="col-md-2 text-center">
					<span class="text-muted">重置成功</span>
				</div>
			</div>
		</div>
		<div class="col-md-2"></div>
...
<div id="addon-container" class="container">
	<div class="row">
		...
		<div class="col-md-4">
			<form class="form-horizontal" data-toggle="validator" role="form" action="${pageContext.request.contextPath}/password/reset/confirm" method="post">
				...
				<div class="form-group">
				    <div>
				    	<input class="btn btn-canary btn-block" type="submit" value="重置">
					</div>
				</div>
			</form>
		</div>
