    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "validateVersion": {
                	"url": "/operation/version/validate",
                	"extraDataDynamic": ['#id'],
                ...
                "validateNews": {
                	"url": "/operation/news/validate",
                	"extraDataDynamic": ['#id'],
                	"alertTextOk": "* 此标题可以使用",
                	"alertText": "* 此标题已被其他人使用",
                	"alertTextLoad": "* 正在确认标题是否已被使用，请稍等。"
                },
                "validateCoupon": {
                	"url": "/coupon/validate",
                	"extraDataDynamic": ['#id'],
                ...
                "validateFinancier": {
                	"url": "/customer/financier/validate",
                	"extraDataDynamic": ['#id'],
                	"alertTextOk": "* 此证件可以使用",
                	"alertText": "* 此证件已被其他人使用",
                	"alertTextLoad": "* 正在确认证件是否已被使用，请稍等。"
                },
                "validate2fields": {
                    "alertText": "* 请输入 HELLO"
                },
