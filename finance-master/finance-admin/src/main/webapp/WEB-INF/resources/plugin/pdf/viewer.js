...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = '/plugin/pdf/images/';
  PDFJS.workerSrc = '/plugin/pdf/pdf.worker.js';
  PDFJS.cMapUrl = '/plugin/pdf/cmaps/';
...
var DEFAULT_URL = '/plugin/pdf/compressed.tracemonkey-pldi-09.pdf';
;
var pdfjsWebApp;
{
